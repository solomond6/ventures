...
define( 'WPCACHEHOME', 'C:\wamp64\www\venturesafrica.com\wp-content\plugins\wp-super-cache/' );
define('DB_NAME', 'wordp1');
/** MySQL database username */
define('DB_USER', 'root');
/** MySQL database password */
//define('DB_PASSWORD', 'vmopFqp87E');
define('DB_PASSWORD', '');
/** MySQL hostname */
 ...
 */
$debug_override = false; // isset($_GET['fsucb']) && $_GET['fsucb'] === 'foochar';
define('WP_DEBUG', $debug_override);
